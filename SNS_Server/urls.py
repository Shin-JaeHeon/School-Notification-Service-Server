...
urlpatterns = [
    ...
    url(r'^error/$', web.error), url(r'^fcm/$', control.fcm), url(r'^school/$', control.school), url(r'^alarm/$', control.alarm), url(r'^alarmr/$', control.alarm_remove),
    url(r'^create/$', web.room),
]
